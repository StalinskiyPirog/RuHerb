...
import { EditRetailer, FindRetailerById, GetRetailers }                                               from "../../components/functions/PrismaCRUD";
...
const REQUIRED_FIELDS = ["retailerId", "name", "surname", "patronymic", "companyName", "categoryId", "email", "city", "phone"];
