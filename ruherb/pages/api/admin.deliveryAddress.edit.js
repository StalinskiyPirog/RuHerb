...
import { CategoryEdit, CreateDeliveryAddress, EditDeliveryAddress}                                               from "../../components/functions/PrismaCRUD";
...
const REQUIRED_FIELDS = ["deliveryAddressId", "address", "name"];
...
export default async function (req, res) {
    ...
    var address = await EditDeliveryAddress({
