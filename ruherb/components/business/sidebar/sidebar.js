...
export default function SideBar({ navigationData, router }) {
  ...
  return (
    <section className="bg-[url('../public/design_parts/sidebar.png')] bg-repeat bg-cover w-sm invisible md:visible absolute border-green-700 right-0 h-auto shadow-md border-2 ">
