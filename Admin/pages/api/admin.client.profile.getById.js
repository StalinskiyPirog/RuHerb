...
import { ClientDelete, ClientEdit, FindClientById, GetClients }                                               from "../../components/functions/PrismaCRUD";
...
const REQUIRED_FIELDS = ["clientId"];
...
export default async function (req, res) {
    ...
    var clients = await FindClientById({
        clientId: fields.clientId
    })
    
    res.status(200).json(SuccessResponse(clients));
}
