...
import { GetRetailers, RetailerConfirmProfile }                                               from "../../components/functions/PrismaCRUD";
...
export default async function (req, res) {
    ...
    var retailers = await GetRetailers({ })
    
    res.status(200).json(SuccessResponse(retailers));
}
