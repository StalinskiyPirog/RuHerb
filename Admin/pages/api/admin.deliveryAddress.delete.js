...
import { CategoryEdit, CreateDeliveryAddress, DeleteDeliveryAddress, EditDeliveryAddress}                                               from "../../components/functions/PrismaCRUD";
...
const REQUIRED_FIELDS = ["deliveryAddressId"];
...
export default async function (req, res) {
    ...
    var address = await DeleteDeliveryAddress({
        id: fields.deliveryAddressId
    })
