...
import { CategoryEdit, CreateCategory, EditProduct, FindCategoriesByIds, FindImagesByIds, FindRetailerById, GetRetailers }                                               from "../../components/functions/PrismaCRUD";
...
const REQUIRED_FIELDS = ["categoryId", "name", "keywords"];
...
export default async function (req, res) {
    ...
    var category = await CategoryEdit({
