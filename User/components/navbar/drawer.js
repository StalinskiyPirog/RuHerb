    ...
    >
      ...
      >
        ...
        <div className="bg-white  rounded-lg border border-gray-200 w-96 text-gray-900">
         ...
         transition
         duration-500
         cursor-pointer" href="/delivery">Доставка</a>
         ...
         transition
         duration-500
         cursor-pointer" href="/payment">Оплата</a>
         ...
         transition
         duration-500
         cursor-pointer" href="/favourite">Избранное</a>
         ...
         transition
         duration-500
         cursor-pointer" href="/lk">Личный кабинет</a>
