...
/**
 * @brief   Поиск товара по фильтру
 * 
 * @returns Товар
 */
 export async function FindProductsByFilter({ filter, skip=0, take=20 }) {
  var req = {
    where: filter,
    include: ProductInclude
  }
...
/**
 * @brief   Поиск товара по тексту
 * 
 * @returns Товар
 */
 export async function FindProductsByText({ text, skip=0, take=20 }) {
  var req = {
    where: {
      OR: [
        {
