...
export default function RegisterPage({}){
  return(<body className="bg-white font-family-karla h-screen">
  ...
  <div className="w-full flex flex-wrap">
      ...
      <div className="w-1/2 shadow-2xl">
        <div className="relative w-full h-screen hidden md:block">
          <Image  src="/design_parts/1608491837_kak-sdelat-ochen-vkusnyj-smuzi.jpg" layout="fill" objectFit="cover" alt="Background" /></div>
      </div>
  </div>
