...
export default function Footer() {
  return (
    <div className="invisible w-screen hidden md:visible md:block bottom-0 inset-y-0">
      <footer className="text-white bg-green-700">
        <div className="h-auto sm:px-6 lg:px-8">
          

          <div className="pt-6 pb-6 border-t border-white/25 sm:items-center sm:justify-between sm:flex">
